...
def select_character_names_and_number_of_books_they_are_in
  "SELECT name, COUNT(*) as book_count FROM character_books JOIN characters ON character_books.character_id = characters.id GROUP BY name ORDER BY book_count DESC, name"
end
